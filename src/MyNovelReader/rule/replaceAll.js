...
/**
 * 全局内容替换规则 (v8.1.0 性能优化版)
 * 优先级说明：长句优先、APP推广优先、短符号噪音最后
 */
const replaceAll = [
  // === 1. 现代移动端 APP 推广与诱导话术 (高频长句) ===
  ...
  // === 5. 网页残留代码块 (JS 遗迹) ===
  'try\\{mad1\\(\'gad2\'\\);\\} ?catch\\(ex\\)\\{\\}', // 修正：合并可选空格，修复单引号嵌套
  'chaptererror\\(\\);',
  '：。：',
  'xqqxs[八8]\\.\\s*$',
  '韆釺哾$',

  // === 6. 针对特定大站（起点/阅文/长佩）的防盗词 ===
